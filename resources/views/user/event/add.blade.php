...
@section('content')
    <div class="container">
        <form action="{{ route('user.event.add') }}" method="POST">
            @csrf
            <div class="row justify-content-center">
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 mb-2">
                    ...
                    <input name="event_name" type="text" class="form-control" placeholder="Event name" maxlength="12"
                           pattern="[A-Z]{1}[a-zA-Z0-9]+" required>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 mb-2">
                    ...
                    <select name="orientation" class="form-control orientation" required>
                        <option value="" selected>Select the orientation</option>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 mb-2">
                    ...
                    <input name="start_time" id="start_time" type="datetime-local" class="form-control" required>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 mb-2">
                    ...
                    <input name="end_time" id="end_time" type="datetime-local" class="form-control" required>
                </div>
                ...
                <section id="tabs" class="col-md-12">
                    ...
                    <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-style" role="tabpanel"
                            ...
                            <div class="row">
                                <input id="style" type="hidden" name="style" value="1"/>
                                <!------------------------------Style 1------------------------------------------>
                        ...
                        <div class="tab-pane fade" id="nav-overlay" role="tabpanel"
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 mb-2 gif hide">
                                ...
                                <div class="col-12 print-template">
                                    ...
                                    <div class="col-12 templates hide">
                                        <div class="row">
                                            <!------------------------------GIF animation------------------------------------------>
                                            ...
                                            <!------------------------------With frame------------------------------------------>
                                            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 mb-2 use_overlay hide">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 overlay1">
                                                ...
                                                <fieldset
                                                    ...
                                                    <img class="col-12 overlay-image-1" src="" alt="">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 overlay2 hide">
                                                ...
                                                <fieldset
                                                    ...
                                                    <img class="col-12 overlay-image-2" src="" alt="">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 overlay3 hide">
                                                ...
                                                <fieldset
                                                    ...
                                                    <img class="col-12 overlay-image-3" src="" alt="">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 overlay4 hide">
                                                ...
                                                <fieldset
                                                    ...
                                                    <img class="col-12 overlay-image-4" src="" alt="">
                                ...
                                <div class="col-12 green_screen-template hide">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                            ...
                                            <input type="range" id="h_value" name="h_value" min="0" max="360" value="0">
                                            <label class="h_value">0</label>
                                        </div>
                                        <!------------------------------S value------------------------------------------>
                                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                            ...
                                            <input type="range" id="s_value" name="s_value" min="0" max="100" value="0">
                                            <label class="s_value">0</label>
                                        </div>
                                        <!------------------------------B value------------------------------------------>
                                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                            ...
                                            <input type="range" id="b_value" name="b_value" min="0" max="100" value="0">
                                            <label class="b_value">0</label>
                                        </div>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                            ...
                                            <fieldset
                                                ...
                                                <img class="col-12 overlay-image-5" src="" alt="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-2">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-2 whatsapp_msg hide">
                                        ...
                                        <input type="text" name="whatsapp_msg" class="form-control" maxlength="255">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-2">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mb-2 sms_msg hide">
                                        <label>Message (max. 255 characters)</label>
                                        <input type="text" name="sms_msg" class="form-control" maxlength="255">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div
                                            class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-2 screen_saver_time hide">
                                            ...
                                            <input name="screen_saver_time" class="form-control" value="15" step="1"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 mb-2 printer_ip hide">
                                            ...
                                            <input id="printer_ip" name="printer_ip" class="form-control" type="text"
                                                   placeholder="xxx.xxx.xxx.xxx" minlength="7" maxlength="15"
                                                   required value="0.0.0.0"
    ...
    <div class="modal fade" id="PrintOverlayModal" tabindex="-1" role="dialog"
         aria-labelledby="printOverlayModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="printOverlayModalLabel">
                        Templates</h5>
                    <button type="button" class="close"
                            data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
    ...
    <div class="modal fade" id="StripOverlayModal" tabindex="-1" role="dialog"
         aria-labelledby="stripOverlayModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="stripOverlayModalLabel">
                        Templates</h5>
                    <button type="button" class="close"
                            data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
...
@section('script')
    <script>
        ...
        $('#start_time').on('change', function () {
            let start_time = new Date($(this).val());
            if (!isNaN(start_time.getTime())) {
                start_time.setDate(start_time.getDate() + 1);
                $("#end_time").val(start_time.getFullYear() + '-'
                    + ('0' + (start_time.getMonth() + 1)).slice(-2)
                    + '-' + ('0' + (start_time.getDate())).slice(-2)
                    + 'T' + ('0' + (start_time.getHours())).slice(-2)
