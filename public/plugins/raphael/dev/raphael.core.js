define(["eve"], function(eve) {
            ...
            for (; l < animationElements.length; l++) {
                ...
                if (time < ms) {
                    ...
                    (function (id, that, anim) {
                        setTimeout(function () {
                            eve("raphael.anim.event." + id, that, anim);
                        });
                    })(that.id, that, e.anim);
                } else {
                    (function(f, el, a) {
                        setTimeout(function() {
                            eve("raphael.anim.event." + el.id, el, a);
    ...
    elproto.onAnimation = function (f) {
        f ? eve.on("raphael.anim.event." + this.id, f) : eve.unbind("raphael.anim.event." + this.id);
        return this;
    };
     ...
     *
     * On each animation event event `anim.event.<id>`, on start `anim.start.<id>` and on end `anim.finish.<id>`.
    \*/
